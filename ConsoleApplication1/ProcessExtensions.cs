        ...
        private static bool GetSessionUserToken(ref IntPtr phUserToken)
        {
            ...
            if (WTSQueryUserToken(activeSessionId, ref hImpersonationToken) != 0)
            {
                ...
                bResult = DuplicateTokenEx(
                    hImpersonationToken, //hExistingToken 
                    0, 
                    IntPtr.Zero,
                    (int)SECURITY_IMPERSONATION_LEVEL.SecurityImpersonation, //ImpersonationLevel 
                    (int)TOKEN_TYPE.TokenPrimary, //TokenType 
                    ref phUserToken); //phNewToken [out]
        ...
        public static bool StartProcessAsCurrentUser(string appPath, string cmdLine = null, string workDir = null, bool visible = true)
        {
            ...
            try
            {
                if (!GetSessionUserToken(ref hUserToken))
                {
                    ...
                    throw new Exception("GetSessionUserToken failed. ERROR Code:" + errCode.ToString());
                }
